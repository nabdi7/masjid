    ...
    return (
        ...
        <footer className='footer'>
            ...
            <div className="copyright">
                    <p>Made by <a href="https://qdwebdesigns.com" target="_blank" rel="noopener noreferrer" style={{ color: 'black', fontWeight: 'bold'}}>QD Web Designs</a> || ©{new Date().getFullYear()} Masjid Al Huda.</p>
            </div>
